...
class StatePredictor(nn.Module):
    def __init__(self,alpha, state_dim0, action_dim,fc1_dim,fc2_dim):
        super(StatePredictor, self).__init__()
        # 输入层到隐藏层
        self.fc1 = nn.Linear(state_dim0+action_dim, fc1_dim)  # 8维状态 + 8维动作 = 16维输入
        self.fc2 = nn.Linear(fc1_dim, fc2_dim)
        # 隐藏层到输出层
        self.fc3 = nn.Linear(fc2_dim, state_dim0)   # 输出是8维状态
